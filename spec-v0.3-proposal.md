# Mosaic — normative specification (v0.3 PROPOSAL)

**Version:** 0.3 (proposal — draft, not yet adopted)
**License:** CC0 1.0 Universal
**Reference implementation:** [Clear](https://github.com/clearcms/clear)
**Status:** Proposed replacement for `v0.2-draft`. Resolves every open issue from the v0.2 peer review (`REVIEW.md`) and v0.2's own open questions in one revision. If adopted, supersedes v0.1 and v0.2-draft. Until adopted, this is non-normative.
...
A **decision log** of every design call made in this proposal is in **Appendix F**. Read that first if you want to know what changed from v0.2 and why.
...
## Appendix F — Decision log (v0.3 proposal)

Every design call made in this proposal where the v0.2 spec was silent or contradictory. Listed so you can override any single one without unraveling the rest.
...
*End of v0.3 proposal. Read Appendix F first for the design log. Compare against `spec.md` (the in-place v0.2 spec) and `REVIEW.md` (the peer review that motivated this revision).*
